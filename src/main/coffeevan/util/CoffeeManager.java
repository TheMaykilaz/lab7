...
public class CoffeeManager {
    ...
    public Map<String, Coffee> getCoupons() {
        return coupons;
    }
    ...
    public void deleteCoffee(String coffeeName) {
        coffeeList.removeIf(coffee -> coffee.getName().equalsIgnoreCase(coffeeName));
    }


    public void saveCoffeesToFile() {
        String filePath = Paths.get("src", "main/coffeevan/coffeeData.txt").toString();
